...
/* DEFINITIONS */
/***************/
#define MAX_NAME_LENGTH_OF_IR_TREE_KIND 100
...
struct T_exp_
{
	...
	union
	{
		...
		struct {T_exp body; Temp_label name;} FUNCTION;
		struct {Temp_label name; T_expList args;} CALL;
...
T_exp T_Function(T_exp body, Temp_label name);
