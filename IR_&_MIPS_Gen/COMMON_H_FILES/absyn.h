...
typedef struct {S_symbol var; S_symbol typ; A_exp init; bool escape;} A_vardec_;
...
struct A_exp_
{
	...
	union
	{
		...
		struct { S_symbol arrayType; int size; int initalized_value; } arrayInit;
	} u;
};
...
struct A_ty_
{
	...
	union {S_symbol name; A_fieldList record; S_symbol array;} u;
};
...
//struct A_vardec_ {S_symbol var; S_symbol typ; A_exp init; bool escape;};
