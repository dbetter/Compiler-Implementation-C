...
#include "../../COMMON_H_FILES/symbol.h" /* symbol table data structures */
#include "../../COMMON_H_FILES/absyn.h"  /* abstract syntax data structures */
#include "../../COMMON_H_FILES/prabsyn.h" /* function prototype */
...
static void pr_dec(FILE *out, A_dec v, int d) {
 ...
 case A_functionDec:
   ...
   pr_fundec(out, v->u.function, d+1); fprintf(out, ")");
   break;
 case A_varDec:
